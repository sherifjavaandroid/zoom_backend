...
<div wire:init="initiateFireabse">
    <div class="flex items-center min-h-screen p-6 bg-gray-50 ">
        <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl border">
            <div class="flex flex-col overflow-y-auto md:flex-row">
                <div class="h-32 md:h-auto md:w-1/2">
                    <img aria-hidden="true" class="object-cover w-full h-full"
                        src="{{ getValidValue(setting('loginImage'), asset('images/reset-password.jpg')) }}"
                        alt="Office" />
                </div>
                {{-- form --}}
                    ...
                    <div class="w-full">
                        ...
                        @if (!$setPassword)
                            <div x-data="otpForm()" x-init="init()">
                                ...
                                {{-- loading indicator --}}
                                <div x-show="loading">
                                    <img src="{{ asset('images/loading2.svg') }}" class="mx-auto my-4" />
                                </div>
                        ...
                        @else
                            <form wire:submit.prevent="saveNewPassword">
                                @csrf
                                <x-input title="New Password" type="password" placeholder="***************"
                                    name="password" />
                                <x-input title="Confirm New Password" type="password" placeholder="***************"
                                ...
                                <div class="flex items-center justify-items-center">
                                    <img src="{{ asset('images/loading2.svg') }}" class="mx-auto my-4" wire:loading
