    ...
    public function updateProfile()
    {
        ...
        $this->validate(
            [
                ...
                "phone" => "phone:" . setting('countryCode', "INTERNATIONAL") . "|unique:users,phone," . Auth::id() . "",
            ]
        );

        //
        $this->phone = str_ireplace(" ", "", PhoneNumber::make($this->phone, setting('countryCode', "INTERNATIONAL"))->formatNational());
